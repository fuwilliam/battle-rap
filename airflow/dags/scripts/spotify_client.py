...
class SpotifyAPI(object):
    ...
    def get_resource(
        self, lookup_id, resource_type="albums", query_postfix="", version="v1"
    ):
    ...
    def get_related_artists(self, _id):
        return self.get_resource(
            _id, resource_type="artists", query_postfix="related-artists"
        )

    def get_top_tracks(self, _id):
        return self.get_resource(
            _id, resource_type="artists", query_postfix="top-tracks?market=US"
        )
    ...
    def get_playlist_artists(self, _id, limit=50, offset=0):
        return self.get_resource(
            ...
            query_postfix=f"tracks?fields=items(track(artists(id, name)))&limit={limit}&offset={offset}",
        )

    def search_artist_by_genre(
        self, genre="hip hop", search_type="artist", limit=50, offset=0
    ):  # type
        headers = self.get_resource_header()
