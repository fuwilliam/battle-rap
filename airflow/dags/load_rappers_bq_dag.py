...
with DAG(
    ...
    load_to_supabase_task = PythonOperator(
        task_id="load_spotify_to_supabase", 
        python_callable=main
    )

    trigger_dbt_cloud_job_task = DbtCloudRunJobOperator(
    ...
    for table_name in tables_to_load:
        ...
        load_to_supabase_task >> load_to_gcs_task >> load_to_bq_task
        load_to_bq_task >> trigger_dbt_cloud_job_task
